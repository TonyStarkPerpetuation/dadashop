# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2019-12-12 10:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_image_url', models.ImageField(default=None, upload_to='', verbose_name='默认图片')),
        ...
        migrations.AddField(
            ...
            name='sale_attr_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.SPUSaleAttr', verbose_name='销售属性'),
        ),
        migrations.AddField(
            model_name='saleattrvalue',
            name='sku',
